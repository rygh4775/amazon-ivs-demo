...
const Chat = () => {
  ...
  const [metadataText,setMetadataText]=useState(true);
    ...
    <>
      ...
      <div className="main full-width full-height chat-container">
        <div className="content-wrapper mg-2">
          ...
          {/*<VideoPlayer playbackUrl={config.PLAYBACK_URL} quiz={quizRef} />*/}
	      {/*<Quiz receiverCreator={receiverCreator}/>*/}
	      {/*<Quiz metadataText={metadataText}/>*/}
